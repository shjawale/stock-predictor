...
companies = ['AAPL', 'AMD', 'FB', 'GOOGL', 'AMZN', 'NVDA', 'NFLX', 'CSCO', 'IBM']
...
Which hyperparameters of the LSTM model (e.g., number of units in LSTM layers, dropout rate, number of dense layers, learning rate) should be tuned.

"""

"""
Keras Sequential Model architecture:
# LSTM size 64, return_sequences, flatten x_train
# LSTM size 64
# dense layer of dimension 32
# dropout rate of 0.5
# dense layer of dimension 1
# compile with Adam as optimizer and mean_squared_error as loss

Based on the architecture, the hyperparameters to tune are:
# units in LSTM layers (64)
# dropout rate (0.5)
# number of dense layers (2 including the output layer) - though typically the output layer is fixed
# units in the dense layer (32 in the hidden dense layer)
# optimizer learning rate (optimizer is currently 'adam', with learning rate as default)
